...
class ConstatTraitement extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return reclamation.chrono == 0 && reclamation.statut == "clôturé"
        ? Scaffold(
            body: Center(
            child: Column(
                ...
                ? Scaffold(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Ce constat a expiré sans traitement.',
                          style:
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              DateFormat('dd/MM/yyyy, HH:mm').format(
                                  reclamation.horaireTraitement?.toDate() ??
                                      DateTime.now()),
                              style: Theme.of(context).textTheme.bodyMedium,
                            ),
                            SizedBox(
                            ...
                            if (reclamation.imageUrl != null &&
                              ...
                              Container(
                                ...
                                child: Image(
                                  image: NetworkImage(
                                      reclamation.imageTraitementUrl!),
                                  fit: BoxFit.cover,
                                ),
                              ),
                          ],
  ...
  showAlertDialog(BuildContext context) {
    ...
    Widget continueButton = ElevatedButton(
      ...
      onPressed: () {
        ...
        cloturerReclamation(
            reclamationId: reclamation.id, horaireCloture: horaireCloture);
        Navigator.pop(context);
      },
    );
